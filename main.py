...
# seperationg each transaction into seperate lists
for i in transactions_clean:
    customers.append(i[0])
    sales.append(i[1])
    threads_sold.append(i[2])
# print(customers)
# print(sales)
print(threads_sold)

# total value of sales per day
total_sales = 0
for i in sales:
    x = i.replace('$', ' ')
    total_sales += float(x)
...
for color in colors:
    color_num = color_count(color)
    print('{} thread amount sold = {}'.format(color, color_num))
